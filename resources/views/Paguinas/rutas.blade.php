...
@section('plantilla')
    <section class="hero">
        <h1 class="text-3xl font-bold sm:text-2xl md:text-4xl">Rutas <span class="text-danger">Expeditions</span></h1>
        ...
        <div class="menu-section hidden lg:flex mb-5"> <!-- mb-4 para separar el menú del contenido siguiente -->
            ...
            <div class="menu-item"><i class="fas fa-hiking"></i><a href="#">Trekking</a></div>
