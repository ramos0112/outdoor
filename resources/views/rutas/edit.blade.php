<!-- Modal -->
<div class="modal fade" id="edit{{ $ruta->id_ruta }}" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="editLabel{{ $ruta->id_ruta }}" aria-hidden="true">
        ...
        <form action="{{ route('rutas.update', $ruta->id_ruta) }}" method="POST" id="ruta-form-edit{{ $ruta->id_ruta }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                    ...
                    <div class="mb-3">
                        <label for="hora_salida{{ $ruta->id_ruta }}" class="form-label">Hora de Salida</label>
                        <input type="time" class="form-control" name="hora_salida"
                            id="hora_salida{{ $ruta->id_ruta }}"
                            value="{{ old('hora_salida', substr($ruta->hora_salida, 0, 5)) }}">
                    </div>
