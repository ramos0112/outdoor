<!-- Modal -->
<div class="modal fade" id="create" data-bs-backdrop="static" tabindex="-1" aria-labelledby="createLabel"
    aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" id="hora_salida" name="hora_salida" value="00:00"
                            required>
                    </div>
                    <div class="mb-3">
